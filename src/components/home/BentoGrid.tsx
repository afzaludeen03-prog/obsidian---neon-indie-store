...
export default function BentoGrid() {
  return (
    <section className="px-12 lg:px-24 py-24 bg-[#0a0a0f] z-10 relative">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
          <h2 className="text-sm font-black text-[#00f3ff] uppercase tracking-[0.3em] mb-4">Spotlight</h2>
