...
export default function WishlistDrawer() {
  ...
  // Lock background body scrolling when wishlist drawer is active
  useEffect(() => {
    if (isWishlistOpen) {
      ...
      {isWishlistOpen && (
        <>
          ...
          >
            ...
            {/* Wishlist Items List */}
            <div className="flex-1 overflow-y-auto p-6 pb-safe space-y-4">
              {wishlist.length === 0 ? (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="mt-2 px-3.5 py-2.5 min-h-[44px] bg-[#a855f7] text-white rounded-lg font-bold text-[10px] uppercase tracking-wider hover:opacity-90 flex items-center justify-center gap-1.5 shadow-neon-purple"
                      >
                        <ShoppingBag className="w-3.5 h-3.5" /> Move to Vault
                      </button>
                    </div>
